...
function avancaProximo(){
    ...
    if(controle == 2){
        ...
        item1.setAttribute("src", "imagens/carrossel4.png")
        item2.setAttribute("src", "imagens/carrossel1.png")
        item3.setAttribute("src", "imagens/carrossel2.png")
        ...
        item1.setAttribute("src", "imagens/carrossel3.png")
        item2.setAttribute("src", "imagens/carrossel4.png")
        item3.setAttribute("src", "imagens/carrossel1.png")
        ...
        item1.setAttribute("src", "imagens/carrossel2.png")
        item2.setAttribute("src", "imagens/carrossel3.png")
        item3.setAttribute("src", "imagens/carrossel4.png")
        ...
        item1.setAttribute("src", "imagens/carrossel1.png")
        item2.setAttribute("src", "imagens/carrossel2.png")
        item3.setAttribute("src", "imagens/carrossel3.png")
